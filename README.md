...
locations across the Bera district, Pahang. Multilingual interface
...
This release migrates Bera District from the older forecast-only build onto
...
```
https://stanleywoosweeleong.github.io/weathernextforberadistrict/
```
...
|---|---|---|---|---|
| Mengkarak | 明加叻 | 3.32000, 102.43000 | open plain | durian |
| Kemasul | 金马苏 | 3.29700, 102.39500 | open plain | durian |
| Triang | 直凉 | 3.24800, 102.41700 | open plain | durian |
| Palm Glove | 直凉园 金河山庄 | 3.23054, 102.39513 | open plain | durian |
| Paya Lang | 巴也郎 | 3.18194, 102.43667 | sheltered basin | durian |
| Simpang Bukit Mendi | 明光 | 3.16572, 102.38601 | open plain | durian |
| Bukit Mendi | 武吉文迪 | 3.17474, 102.35056 | sheltered basin | durian |
| Kemayan Taman Maju Jaya | 金马扬 1 | 3.12427, 102.36320 | open plain | durian |
| Kemayan Taman Ixnora Jaya | 金马扬 2 | 3.14184, 102.36395 | open plain | durian |
| Sungai Rui | 双溪镭 | 3.09639, 102.35861 | riverine | durian |
...
The app also seeds a default user display name (**百乐县**, ASCII slug **BeraDistrict**),
which stays editable via **Edit Name** in the app.

This build carries the seed version **`bd-arch1`** (the lowland-architecture
...
```
wnext-weathernextforberadistrict-202606031920
```
...
- **Storage namespace:** `weathernextforberadistrict__*` keys in `localStorage`, isolated
  from other WeatherNext regional builds so data never collides.
- **Cloud sync:** Firebase, namespaced under `appId: wnext-ag-v41-weathernextforberadistrict`.
